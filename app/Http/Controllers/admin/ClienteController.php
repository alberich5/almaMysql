...
class ClienteController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->paginate(7);
            return view('admin.ventas.cliente.index',["personas"=>$personas,"searchText"=>$query]);
        }
    }
    ...
    {
        return view("admin.ventas.cliente.create");
    }
    ...
    {
        return view("admin.ventas.cliente.show",["persona"=>Persona::findOrFail($id)]);
    }

    //Funcion para mostar la vista para editar clientes
    public function edit($id)
    {
        return view("admin.ventas.cliente.edit",["persona"=>Persona::findOrFail($id)]);
    }
