...
class ArticuloController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.almacen.articulo.create",["categorias"=>$categorias]);
    }
    ...
    public function store (ArticuloFormRequest $request)
    {
        ...
        return Redirect::to('admin/almacen-articulo');
    ...
    {
        return view("admin.almacen.articulo.show",["articulo"=>Articulo::findOrFail($id)]);
    }
    ...
    public function edit($id)
    {
        ...
        $categorias=DB::table('categoria')->where('condicion','=','1')->get();
        //retornar la vista
        return view("admin.almacen.articulo.edit",["articulo"=>$articulo,"categorias"=>$categorias]);
