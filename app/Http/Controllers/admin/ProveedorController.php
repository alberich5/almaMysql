...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->paginate(7);
            return view('admin.compras.proveedor.index',["personas"=>$personas,"searchText"=>$query]);
        }
    }
    ...
    {
        return view("admin.compras.proveedor.create");
    }
    ...
    public function store (PersonaFormRequest $request)
    {
        ...
        $persona->save();
        return Redirect::to('admin/almacen-proveedor');
    ...
    {
        return view("admin.compras.proveedor.show",["persona"=>Persona::findOrFail($id)]);
    }

    //funcion para editar cada proveedor
     public function edit($id)
    {
        return view("admin.compras.proveedor.edit",["persona"=>Persona::findOrFail($id)]);
    }
