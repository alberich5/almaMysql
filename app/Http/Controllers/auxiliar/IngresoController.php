...
class IngresoController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
           ...
           $ingresos=DB::table('ingreso as i')
            ...
            return view('auxiliar.compras.ingreso.index',["ingresos"=>$ingresos,"searchText"=>$query]);
        }
    }
    ...
    public function create()
    {
     ...
     $articulos = DB::table('articulo as art')
            ...
            ->get();
        return view("auxiliar.compras.ingreso.create",["personas"=>$personas,"articulos"=>$articulos]);
    }
     ...
     public function show($id)
    {
        ...
        return view("auxiliar.compras.ingreso.show",["ingreso"=>$ingreso,"detalles"=>$detalles]);
    }
