...
class CategoriaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->paginate(7);
            return view('auxiliar.almacen.categoria.index',["categorias"=>$categorias,"searchText"=>$query]);
        }
    }
    ...
    public function create()
    {
        ...
        return view("auxiliar.almacen.categoria.create");
    }
    ...
    {
        return view("auxiliar.almacen.categoria.show",["categoria"=>Categoria::findOrFail($id)]);
    }

    //funcion para editar las categorias
    public function edit($id)
    {
        return view("auxiliar.almacen.categoria.edit",["categoria"=>Categoria::findOrFail($id)]);
    }
